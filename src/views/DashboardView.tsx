  ...
  return (
    <div className="space-y-6">
      ...
      <div className="col-span-1 row-span-1 bg-slate-900 border border-slate-800 rounded-2xl p-5 flex flex-col justify-between">
        <span className="text-slate-500 text-xs font-semibold uppercase tracking-wider mb-2">Total Pendapatan</span>
      ...
      <div className="col-span-1 row-span-1 bg-slate-900 border border-slate-800 rounded-2xl p-5 flex flex-col justify-between">
        <span className="text-slate-500 text-xs font-semibold uppercase tracking-wider mb-2">Total Produksi</span>
        <div className="flex flex-col gap-1">
          ...
          <div className="flex justify-between items-center mt-1 text-xs">
             <span className="text-slate-400">PLTA: <span className="text-indigo-400 font-medium">{new Intl.NumberFormat('id-ID').format(totalPlta)}</span></span>
             <span className="text-slate-400">Mini: <span className="text-cyan-400 font-medium">{new Intl.NumberFormat('id-ID').format(totalMiniHydro)}</span></span>
          </div>
        </div>
      </div>

      <div className="col-span-1 row-span-1 bg-slate-900 border border-slate-800 rounded-2xl p-5 flex flex-col justify-between hidden md:flex">
        <span className="text-slate-500 text-xs font-semibold uppercase tracking-wider mb-2">Produksi PT PLN</span>
        <div className="flex flex-col gap-1">
          <span className="text-xl font-bold text-white tracking-tight">
            {formatRupiah(totalPln)}
          </span>
          <span className="text-indigo-400 text-xs font-medium">
            {new Intl.NumberFormat('id-ID').format(totalPlnKwh)} kWh
          </span>
        </div>
      </div>

      <div className="col-span-1 row-span-1 bg-slate-900 border border-slate-800 rounded-2xl p-5 flex flex-col justify-between hidden md:flex">
        <span className="text-slate-500 text-xs font-semibold uppercase tracking-wider mb-2">Produksi PS & Terjual</span>
        <div className="flex flex-col gap-1">
          <span className="text-xl font-bold text-white tracking-tight">
            {formatRupiah(totalPs)}
          </span>
          <span className="text-cyan-400 text-xs font-medium">
            {new Intl.NumberFormat('id-ID').format(totalPsKwh)} kWh
          </span>
        </div>
      </div>
